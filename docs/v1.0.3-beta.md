...
This class constructs a JSONObject from JSON string (note: it cannot construct an object that has an object inside of it, this will be fixed in v1.0.5-beta)  
Example of this class in action:  
```java
