...
You can convert the JSONObject into a string of JSON using the `toJSONString()` function (note: when it tries to convert an object key into a JSON string, it gives broken output)  
